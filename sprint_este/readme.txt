...
* in-sp5-base.txt    : usage normal des commandes "formation" et "epreuve" 
* in-sp5-erreur.txt  : usage provoquant tous les messages d'erreur de cette commande
* in-sp6-base.txt    : usage normal des commandes "note", "notes" et "releve" 
* in-sp6-erreur.txt  : usage provoquant tous les messages d'erreur de cette commande
* in-sp7-base.txt    : usage normal de la commande "decision" 
* in-sp7-erreur.txt  : usage provoquant tous les messages d'erreur de cette commande
* in-sp8-base.txt    : usage normal de la commande "coefficient" 
* in-sp8-erreur.txt  : usage provoquant tous les messages d'erreur de cette commande